...
// Consultar os cheques dos clientes
$sql = "SELECT * FROM cheques_clientes";
...
<head>
    ...
    <title>Cheques dos Clientes</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body class="bg-gray-100">
    <div class="min-h-screen flex items-center justify-center">
        <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-5xl">
            <h2 class="text-2xl font-bold mb-6 text-center">Cheques dos Clientes</h2>
                ...
                <tbody>
                    <?php if ($result->num_rows > 0): ?>
                        <?php while ($row = $result->fetch_assoc()): ?>
                            <tr>
                                <td class="px-4 py-2 border"><?php echo $row['cliente_id']; ?></td>
                                ...
                                <td class="px-4 py-2 border">
                                    <a href="excluir_cheque_cliente.php?id=<?php echo $row['id']; ?>" class="bg-red-500 text-white px-4 py-2 rounded-lg" onclick="return confirm('Tem certeza que deseja excluir este cheque?')">Excluir</a>
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    <?php else: ?>
