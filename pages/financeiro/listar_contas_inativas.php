...
// Consultar as contas inativas
$sql = "SELECT * FROM contas_receber WHERE status = 'inativo'";
...
<head>
    ...
    <title>Contas Inativas</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body class="bg-gray-100">
    <div class="min-h-screen flex items-center justify-center">
        <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-5xl">
            <h2 class="text-2xl font-bold mb-6 text-center">Contas Inativas</h2>

            <!-- Tabela de Contas Inativas -->
            <table class="w-full table-auto bg-white border rounded-lg">
                ...
                <tbody>
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="4" class="px-4 py-2 text-center text-gray-500">Nenhuma conta inativa encontrada.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
